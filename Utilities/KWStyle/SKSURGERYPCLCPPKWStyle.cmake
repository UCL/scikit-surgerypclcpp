...
OPTION(SKSURGERYPCLCPP_USE_KWSTYLE "Enable the use of KWStyle for checking coding style." OFF)
IF(SKSURGERYPCLCPP_USE_KWSTYLE)
...
SET(KWSTYLE_CONFIGURATION_FILE 
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/SKSURGERYPCLCPPKWS.xml)

SET(KWSTYLE_SKSURGERYPCLCPP_FILES_LIST
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/SKSURGERYPCLCPPFiles.txt)

SET(KWSTYLE_SKSURGERYPCLCPP_OVERWRITE_FILE
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/SKSURGERYPCLCPPOverwrite.txt )

#
# Configure the files
#
CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/SKSURGERYPCLCPPFiles.txt.in
  ${KWSTYLE_SKSURGERYPCLCPP_FILES_LIST})

CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/SKSURGERYPCLCPPKWS.xml.in
...
SET(KWSTYLE_ARGUMENTS_CODE
  -xml ${KWSTYLE_CONFIGURATION_FILE} -v -D ${KWSTYLE_SKSURGERYPCLCPP_FILES_LIST}
  -o ${KWSTYLE_SKSURGERYPCLCPP_OVERWRITE_FILE} ${KWSTYLE_EDITOR_FORMAT}
  )

ADD_CUSTOM_COMMAND(
  OUTPUT  ${SKSURGERYPCLCPP_BINARY_DIR}/KWStyleCodeReport.txt
  COMMAND ${KWSTYLE_EXECUTABLE}
  ARGS    ${KWSTYLE_ARGUMENTS_CODE}
  COMMENT "Coding Style Checker"
  )

ADD_CUSTOM_TARGET(StyleCheckCode DEPENDS ${SKSURGERYPCLCPP_BINARY_DIR}/KWStyleCodeReport.txt)

ADD_TEST(KWStyle ${KWSTYLE_EXECUTABLE} ${KWSTYLE_ARGUMENTS_CODE})

ENDIF(KWSTYLE_FOUND)
ENDIF(KWSTYLE_EXECUTABLE)
ENDIF(SKSURGERYPCLCPP_USE_KWSTYLE)
