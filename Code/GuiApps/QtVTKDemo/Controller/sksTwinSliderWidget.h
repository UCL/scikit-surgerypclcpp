...
#ifndef sksTwinSliderWidget_h
#define sksTwinSliderWidget_h

#include "sksQtVTKControllerWin32ExportHeader.h"
#include "ui_sksTwinSliderWidget.h"
...
*/
class SKSURGERYPCLCPP_QTVTKCONTROLLERWINEXPORT TwinSliderWidget : public QWidget, Ui_TwinSliderWidget
{
  Q_OBJECT
