...
#ifndef sksVolumeRenderingModel_h
#define sksVolumeRenderingModel_h

#include "sksQtVTKModelWin32ExportHeader.h"
...
*/
  class SKSURGERYPCLCPP_QTVTKMODELWINEXPORT VolumeRenderingModel : public QObject
{
  Q_OBJECT
