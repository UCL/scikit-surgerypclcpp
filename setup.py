...
#   SKSURGERYPCLCPP_PYTHON_MODULE_NAME to give the output python module the correct name.
#   SKSURGERYPCLCPP_PYTHON_OUTPUT_DIRECTORY to produce the output python module in the correct place
...
class CMakeExtension(Extension):
    def __init__(self, name, sourcedir=''):
        ...
        self.build_dir = os.path.join(self.super_build_dir, 'SKSURGERYPCLCPP-build')
...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        cmake_args = ['-DSKSURGERYPCLCPP_PYTHON_OUTPUT_DIRECTORY:PATH=' + ext_dir,
                      '-DSKSURGERYPCLCPP_PYTHON_MODULE_NAME:STRING=' + ext.name
                      ]
        build_args = []
...
setup(
    ...
    description='Image guided surgery functions, using PCL in C++, but built into a Python extension.',
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://github.com/UCL/scikit-surgerypclcpp',
    ext_modules=[CMakeExtension('sksurgerypclpython', sourcedir=dir_path)],
