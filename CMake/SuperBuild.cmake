...
# This allows switching branches in the SKSURGERYPCLCPP source code and build SKSURGERYPCLCPP quickly, even if the
...
# SKSURGERYPCLCPP-configure timestamp manually before doing a superbuild. Without that the CMake cache is
...
set(EP_COMMON_ARGS
  ...
  "-DCMAKE_CXX_FLAGS:STRING=${CMAKE_CXX_FLAGS} ${SKSURGERYPCLCPP_CXX11_FLAG}"
  #debug flags
...
set(SKSURGERYPCLCPP_SUPERBUILD_DEBUG_POSTFIX d)
...
######################################################################
include(sksExternalProjectHelperMacros)
...
######################################################################
# Now compile SKSURGERYPCLCPP, using the packages we just provided.
######################################################################
if(NOT DEFINED SUPERBUILD_EXCLUDE_SKSURGERYPCLCPPBUILD_TARGET OR NOT SUPERBUILD_EXCLUDE_SKSURGERYPCLCPPBUILD_TARGET)
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_ARGS
      ...
      -DSKSURGERYPCLCPP_SUPERBUILD_DEBUG_POSTFIX:STRING=${SKSURGERYPCLCPP_SUPERBUILD_DEBUG_POSTFIX}
    CMAKE_CACHE_ARGS
      ${EP_COMMON_CACHE_ARGS}
      -DCMAKE_LIBRARY_PATH:PATH=${CMAKE_LIBRARY_PATH}
      -DCMAKE_INCLUDE_PATH:PATH=${CMAKE_INCLUDE_PATH}
      -DSKSURGERYPCLCPP_EXTERNAL_PROJECT_PREFIX:PATH=${ep_prefix}
      -DSKSURGERYPCLCPP_USE_KWSTYLE:BOOL=${SKSURGERYPCLCPP_USE_KWSTYLE}
      -DSKSURGERYPCLCPP_USE_CPPCHECK:BOOL=${SKSURGERYPCLCPP_USE_CPPCHECK}
      -DSKSURGERYPCLCPP_USE_QT:BOOL=${SKSURGERYPCLCPP_USE_QT}
      -DSKSURGERYPCLCPP_USE_OPENMP:BOOL=${SKSURGERYPCLCPP_USE_OPENMP}
      -DSKSURGERYPCLCPP_USE_CUDA:BOOL=${SKSURGERYPCLCPP_USE_CUDA}
      -DSKSURGERYPCLCPP_DELAYLOAD_CUDA:BOOL=${SKSURGERYPCLCPP_DELAYLOAD_CUDA}
      -DSKSURGERYPCLCPP_CUDA_ARCH_BIN:STRING=${SKSURGERYPCLCPP_CUDA_ARCH_BIN}
      -DCUDA_TOOLKIT_ROOT_DIR:PATH=${CUDA_TOOLKIT_ROOT_DIR}
      -DSKSURGERYPCLCPP_USE_MPI:BOOL=${SKSURGERYPCLCPP_USE_MPI}
      -DCMAKE_INSTALL_PREFIX:PATH=${CMAKE_INSTALL_PREFIX}
      "-DCMAKE_INSTALL_RPATH:STRING=${_install_rpath}"
      -DCMAKE_VERBOSE_MAKEFILE:BOOL=${CMAKE_VERBOSE_MAKEFILE}
      -DBUILD_TESTING:BOOL=${BUILD_TESTING} # The value set in EP_COMMON_ARGS normally forces this off, but we may need SKSURGERYPCLCPP to be on.
      ...
      -DSKSURGERYPCLCPP_PYTHON_VERSION:STRING=${SKSURGERYPCLCPP_PYTHON_VERSION}
      -DBUILD_UNITY_WRAPPER:BOOL=${BUILD_UNITY_WRAPPER}
      -DSKSURGERYPCLCPP_UNITY_PLUGIN_DIR:PATH=${SKSURGERYPCLCPP_UNITY_PLUGIN_DIR}
