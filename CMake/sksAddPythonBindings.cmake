...
if(BUILD_Python_Boost OR BUILD_Python_PyBind)
  ...
  set(Python_ADDITIONAL_VERSIONS ${SKSURGERYPCLCPP_PYTHON_VERSION})
  ...
  if(BUILD_Python_Boost)
    ...
    if (WITHIN_SUBBUILD)
      list(APPEND SKSURGERYPCLCPP_BOOST_LIBS "python${PYTHON_VERSION_MAJOR}${PYTHON_VERSION_MINOR}")
	  ...
	  # list(APPEND SKSURGERYPCLCPP_BOOST_LIBS "numpy${PYTHON_VERSION_MAJOR}${PYTHON_VERSION_MINOR}")
    else()
      list(APPEND SKSURGERYPCLCPP_BOOST_LIBS "python")
    endif()
    list(REMOVE_DUPLICATES SKSURGERYPCLCPP_BOOST_LIBS)
  endif()
endif()
