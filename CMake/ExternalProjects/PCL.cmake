...
if(NOT DEFINED PCL_DIR)
  ...
  set(_cuda_options
    -DBUILD_CUDA:BOOL=${SKSURGERYPCLCPP_USE_CUDA}
    -DBUILD_GPU:BOOL=${SKSURGERYPCLCPP_USE_CUDA}
  )
  if(SKSURGERYPCLCPP_USE_CUDA)
    list(APPEND _cuda_options
      -DCUDA_TOOLKIT_ROOT_DIR:PATH=${CUDA_TOOLKIT_ROOT_DIR}
      -DCUDA_ARCH_BIN:STRING=${SKSURGERYPCLCPP_CUDA_ARCH_BIN}
      -DCUDA_NVCC_FLAGS:STRING=${SKSURGERYPCLCPP_CXX11_FLAG}
  ...
  ExternalProject_Add(${proj}
    ...
    #COMMAND ${PATCH_COMMAND} -N -p1 -i ${CMAKE_CURRENT_LIST_DIR}/PCL-Boost.patch
    CMAKE_GENERATOR ${gen}
    CMAKE_ARGS
      ${EP_COMMON_ARGS}
