...
set(SKSURGERYPCLCPP_USE_Boost 1)
set(SKSURGERYPCLCPP_USE_Boost_LIBRARIES ${SKSURGERYPCLCPP_BOOST_LIBS})
set(SKSURGERYPCLCPP_BUILD_PYTHON_BINDINGS OFF)
...
string(REPLACE "^^" ";" SKSURGERYPCLCPP_USE_Boost_LIBRARIES "${SKSURGERYPCLCPP_USE_Boost_LIBRARIES}")

if(NOT DEFINED BOOST_ROOT AND NOT SKSURGERYPCLCPP_USE_SYSTEM_Boost)
  ...
  if(SKSURGERYPCLCPP_USE_Boost_LIBRARIES)
    string(REPLACE ";" "," _boost_libs "${SKSURGERYPCLCPP_USE_Boost_LIBRARIES}")
    foreach(_boost_lib ${SKSURGERYPCLCPP_USE_Boost_LIBRARIES})
	  ...
	  if("${_boost_lib}" STREQUAL "python" OR "${_boost_lib}" STREQUAL "python${PYTHON_VERSION_MAJOR}${PYTHON_VERSION_MINOR}")
	    set(SKSURGERYPCLCPP_BUILD_PYTHON_BINDINGS ON)
	  endif()
    endforeach()
  endif()
  ...
  if(SKSURGERYPCLCPP_BUILD_PYTHON_BINDINGS)
  ...
  set(_boost_cxxflags )
  if(CMAKE_CXX_FLAGS OR SKSURGERYPCLCPP_CXX11_FLAG OR PythonLibs_FOUND)
    set(_boost_cxxflags "cxxflags=${SKSURGERYPCLCPP_CXX11_FLAG} ${CMAKE_CXX_FLAGS}")
    if(WIN32)
  ...
  # Manual install commands (for a SKSURGERYPCLCPP super-build install)
