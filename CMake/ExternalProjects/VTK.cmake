...
if(NOT DEFINED VTK_DIR)
  ...
  if(BUILD_Python_Boost OR BUILD_Python_PyBind)
    ...
    # Look in sksAddVTK, as we either build v6.1.0, or v8.2.0.
  ...
  option(SKSURGERYPCLCPP_VTK_DEBUG_LEAKS OFF)
  mark_as_advanced(SKSURGERYPCLCPP_VTK_DEBUG_LEAKS)
  list(APPEND additional_cmake_args
  ...
  if(Qt5_DIR AND SKSURGERYPCLCPP_USE_QT)
    list(APPEND additional_cmake_args
